...
-- Add this to your Seed data section (Use a hashed password from your signup to replace 'password')
INSERT INTO Users (Username, Email, Password, Role) 
VALUES ('SuperAdmin', 'admin@hub.com', '$2y$10$YourHashedPasswordHere', 'admin');