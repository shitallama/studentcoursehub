    ...
    <main class="admin-content">
        <div class="admin-header">
            ...
            <div class="admin-actions">
                <a href="module-edit.php?id=<?= $id ?>" class="admin-btn admin-btn-edit">
            ...
            <div>
                ...
                <div class="admin-card">
                    ...
                    <div class="admin-card-body" style="display:flex; flex-direction:column; gap:0.6rem;">
                        <a href="module-edit.php?id=<?= $id ?>" class="admin-btn admin-btn-edit" style="width:100%;">
                            <span class="nav-icon">✏️</span> Edit Module
                        </a>
                        <a href="modules.php" class="admin-btn admin-btn-view" style="width:100%;">
                            <span class="nav-icon">📖</span> All Modules
                        </a>
                    </div>
                </div>
            </div>
