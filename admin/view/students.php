...
<title>Interested Students | Student Course Hub</title>
            ...
            <div class="admin-card-body">
                ...
                <table class="admin-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>#<?= $s['InterestID'] ?></td>
                            <td><strong><?= htmlspecialchars($s['StudentDisplayName']) ?></strong></td>
                            ...
                            <td class="admin-table-actions">
                                <a href="../controller/students-edit.php?id=<?= $s['InterestID'] ?><?= $programme_filter ? '&programme_id=' . (int)$programme_filter : '' ?>" class="admin-btn admin-btn-edit admin-btn-sm"><span class="nav-icon"><span class="icon-svg icon-edit" aria-hidden="true"></span></span>Edit</a>
                                <a href="students.php?delete=<?= $s['InterestID'] ?><?= $programme_filter ? '&programme_id=' . (int)$programme_filter : '' ?>"
                                   ...
                                   onclick="return confirm('Are you sure you want to delete this student record?')"><span class="nav-icon"><span class="icon-svg icon-delete" aria-hidden="true"></span></span>Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
