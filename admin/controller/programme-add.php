...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute([$name, $description, $level_id, $leader_id])) {
        header("Location: ../view/programmes.php?msg=added");
        exit;
    }
}
?>

<title>Add Programme | Student Course Hub</title>
            ...
            <div class="admin-card-body">
                <form method="POST" class="admin-form">
                    <div class="admin-form-group">
                        ...
                        <input type="text" id="name" name="name" placeholder="Enter programme name" required>
                    </div>
