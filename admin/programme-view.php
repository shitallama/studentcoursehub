    ...
    <main class="admin-content">
        <div class="admin-header">
            ...
            <div class="admin-actions">
                <a href="programme-edit.php?id=<?= $id ?>" class="admin-btn admin-btn-edit">
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 1.5rem;">
            ...
            <div>
                ...
                <div class="admin-card">
                    <div class="admin-card-header">
                        <h2>Modules</h2>
                        <a href="module-add.php?programme_id=<?= $id ?>" class="admin-btn admin-btn-primary admin-btn-sm">
                            <span class="nav-icon">➕</span> Add Module
                        </a>
                    </div>
                    <div class="admin-card-body">
                        <?php if ($module_list): ?>
                            ...
                            <div style="background: var(--warm-gray-100); padding: 1rem; border-radius: 8px; margin-bottom: 0.5rem; display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <div>
                                    <a href="module-edit.php?id=<?= $mod['ModuleID'] ?>" class="admin-btn admin-btn-edit admin-btn-sm">✏️</a>
                                </div>
                            </div>
                            <?php endforeach; ?>
                        <?php else: ?>
                ...
                <div class="admin-card">
                    ...
                    <div class="admin-card-body">
                        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                            <a href="programme-edit.php?id=<?= $id ?>" class="admin-btn admin-btn-edit" style="width: 100%;">
                                <span class="nav-icon">✏️</span> Edit Programme
                            </a>
                            <a href="module-add.php?programme_id=<?= $id ?>" class="admin-btn admin-btn-primary" style="width: 100%;">
                                <span class="nav-icon">➕</span> Add Module
                            </a>
                        </div>
                    </div>
